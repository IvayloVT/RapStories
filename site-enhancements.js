...
window.RAP_STORIES_BASE_URL = window.RAP_STORIES_BASE_URL
  ...
  function injectCookieConsentStyles() {
    ...
    style.textContent = [
      ...
      ".footer-wrap>div:first-child{flex:1 1 520px;min-width:0}",
      ".footer-links{flex:0 1 auto;align-items:center;justify-content:flex-end;white-space:nowrap}",
      ...
      "@media (max-width:760px){.footer-wrap>div:first-child{flex-basis:100%}.footer-links{justify-content:flex-start;white-space:normal}}",
  ...
  function setupHeaderMenu() {
    ...
    if (cta) {
      cta.setAttribute("href", "stories.html");
      cta.textContent = "Read Stories";
    }
