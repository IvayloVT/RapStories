...
window.RAP_STORIES_BASE_URL = window.RAP_STORIES_BASE_URL
  ...
  function injectCookieConsentStyles() {
    ...
    style.textContent = [
      ...
      "footer .footer-wrap{width:calc(100% - 84px);max-width:none;margin-left:auto;margin-right:auto;display:grid;grid-template-columns:minmax(0,1fr) auto;column-gap:20px;align-items:start}",
